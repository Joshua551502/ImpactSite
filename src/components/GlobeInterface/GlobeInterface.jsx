...
export default function GlobeInterface() {
  ...
  return (
    ...
    <div className={styles.GlobeInterface}>
      ...
      <div
        className={`${styles.monitorPanel} ${isMonitorOpen ? styles.open : ""}`}
      >
      ...
      <div className={styles.mapContainer}>
        ...
        <div className={styles.globaltemp}>
          ...
          <div className={styles.logos}>
            <img src="/medias/mapbox/undp.png" className={styles.undp}></img>
            <img src="/medias/mapbox/oxford.png"  className={styles.oxford}></img>
            <img src="/medias/mapbox/theworldbank.png"  className={styles.theworldbank}></img>
          </div>
          {isModalOpen && (
          ...
          <div className={styles.card}>
            <img src="/medias/carousel-card/common.svg" className={styles.border}></img>
            <div className={styles.content}>
              <img src="/medias/carousel-card/first-image.png" className={styles.cardImage} />
              <div className={styles.rarity}>UNCOMMON</div>
              <div className={styles.values}>
                <img src="/medias/carousel-card/carousel-card-sdgs/13.png" className={styles.unsdg} />
                <img src="/medias/carousel-card/carousel-card-sdgs/14.png" className={styles.unsdg} />
                <img src="/medias/carousel-card/qrcode.png" className={styles.qrcode} />
              </div>
