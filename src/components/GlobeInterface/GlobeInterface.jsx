...
import globeButton from "@/assets/images/globe-interface/button.svg";
import undp from "@/assets/images/mapbox/undp.png";
import theworldbank from "@/assets/images/mapbox/theworldbank.png";
import oxford from "@/assets/images/mapbox/oxford.png";
...
import cardImage from "@/assets/images/placeholder-card.png";
  ...
  return (
    <div className={styles.GlobeInterface}>
      <div className={styles.container}>
        ...
        <div className={`${styles.monitorPanel} ${isMonitorOpen ? styles.open : ""}`}>
          <div className={styles.monitorContent}>
            ...
            <div className={styles.featuredCause}>
            ...
            <div className={styles.causeCampaigns}>
              <img src={cardImage}/>
              <img src={cardImage}/>
              <img src={cardImage} id={styles.specialCard}/>
              <img src={cardImage}/>
              <img src={cardImage}/>
              <img src={cardImage}/>
              <img src={cardImage}/>
        ...
        <div className={styles.mapContainer}>
          ...
          <div className={styles.logos}>
            <img src={undp} className={styles.undp}></img>
            <img src={oxford} className={styles.oxford}></img>
            <img src={theworldbank} className={styles.theworldbank}></img>
          </div>
          {isModalOpen && (
          ...
          <div className={styles.card}>
            <img src={common} className={styles.border}></img>
            <div className={styles.content}>
              <img src={firstImage} className={styles.cardImage} />
              <div className={styles.rarity}>UNCOMMON</div>
              <div className={styles.values}>
                <img src={thirteen} className={styles.unsdg} />
                <img src={fourteen} className={styles.unsdg} />
